...
final public class Config {
	...
	public static final int DRIVELINE_RIGHT_MIDDLE_MOTOR_PORT 		= 2;
	...
	public static final int DRIVELINE_SOLENOID_PORT_1 				= 7;
	public static final int DRIVELINE_SOLENOID_PORT_2				= 6;
