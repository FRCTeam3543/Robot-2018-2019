 ...
 *
 * These are grouped into a subsystem because all the sensors and actuators work
 * together.
 * 
 *
 */
...
//	private Compressor airpusher;  // should not need this - doubleSolenoid will start the compressor
    ...
    public DriveLine() {
       ...
       WPI_TalonSRX rightMiddleTalon = new WPI_TalonSRX(Config.DRIVELINE_RIGHT_MIDDLE_MOTOR_PORT);
        ...
        leftMiddleTalon.setNeutralMode(NeutralMode.Coast);
        leftFrontTalon.setNeutralMode(NeutralMode.Coast);
        
        rightFrontTalon.setNeutralMode(NeutralMode.Coast);
        rightMiddleTalon.setNeutralMode(NeutralMode.Coast);
        rightRearTalon.setNeutralMode(NeutralMode.Coast);
        
        // right front is inverted
        leftFrontTalon.setInverted(InvertType.None);        
        leftMiddleTalon.setInverted(InvertType.None);
        leftRearTalon.setInverted(InvertType.None);

        leftMiddleTalon.follow(leftFrontTalon);
        leftRearTalon.follow(leftFrontTalon);

        rightFrontTalon.setInverted(InvertType.None);
        rightMiddleTalon.setInverted(InvertType.None);
        rightRearTalon.setInverted(InvertType.None);
